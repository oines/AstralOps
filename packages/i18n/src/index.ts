...
export const mobileResources = {
  en: {
    ...
    mobile: {
      ...
      hostsFromCloud: "Cloud lists only device identity, presence, revocation and routing metadata.",
      workbenchPending: "Host workbench is not connected yet",
      workbenchPendingDetail: "Mobile has the Cloud/Mesh account layer; HostRemoteSession transport is the next step.",
    },
    status: {
      local: "Local",
      lan: "LAN",
  ...
  "zh-CN": {
    ...
    mobile: {
      ...
      hostsFromCloud: "Cloud 只保存设备公开身份、在线状态、撤销状态和路由元数据。",
      workbenchPending: "Host 工作台还未接入",
      workbenchPendingDetail: "移动端已接入 Cloud/Mesh 账号层；下一步接 HostRemoteSession 远控传输。",
    },
    status: {
      local: "本机",
      lan: "LAN",
